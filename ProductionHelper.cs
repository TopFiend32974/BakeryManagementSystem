            ...
            try
            {
                ...
                {                    
                    ...
                    if (ordersByDay.Count > 0)
                    {
                        ...
                        if (totalMedVeg > 0)
                        {
                            worksheet.Cells[row, 2].Value = "Med Vegan:";
                ...
                using (var package = new ExcelPackage(new FileInfo(excelFilePath)))
                {
                    ...
                    foreach (var product in combinedProducts)
                    {
                        ...
                        else if (product.ProductQuantity > 0)
                        {
                            ...
                            {
                                worksheet.Cells[row, 4].Value = AdjustEquation((product.ProductQuantity * 4 ), 20, halfDivider);
                            }
